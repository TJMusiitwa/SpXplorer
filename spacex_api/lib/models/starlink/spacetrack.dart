...
class SpaceTrack {
  ...
  factory SpaceTrack.fromJson(Map<String, dynamic> json) => SpaceTrack(
        ccsdsOmmVers:
            json["CCSDS_OMM_VERS"] == null ? null : json["CCSDS_OMM_VERS"],
        comment: json["COMMENT"] == null ? null : json["COMMENT"],
        creationDate: json["CREATION_DATE"] == null
            ? null
            : DateTime.parse(json["CREATION_DATE"]),
        originator: json["ORIGINATOR"] == null ? null : json["ORIGINATOR"],
        objectName: json["OBJECT_NAME"] == null ? null : json["OBJECT_NAME"],
        objectId: json["OBJECT_ID"] == null ? null : json["OBJECT_ID"],
        centerName: json["CENTER_NAME"] == null ? null : json["CENTER_NAME"],
        refFrame: json["REF_FRAME"] == null ? null : json["REF_FRAME"],
        timeSystem: json["TIME_SYSTEM"] == null ? null : json["TIME_SYSTEM"],
        meanElementTheory: json["MEAN_ELEMENT_THEORY"] == null
            ? null
        ...
        inclination:
            json["INCLINATION"] == null ? null : json["INCLINATION"].toDouble(),
        raOfAscNode: json["RA_OF_ASC_NODE"] == null
            ? null
            : json["RA_OF_ASC_NODE"].toDouble(),
        ...
        ephemerisType:
            json["EPHEMERIS_TYPE"] == null ? null : json["EPHEMERIS_TYPE"],
        classificationType: json["CLASSIFICATION_TYPE"] == null
            ? null
            : json["CLASSIFICATION_TYPE"],
        noradCatId: json["NORAD_CAT_ID"] == null ? null : json["NORAD_CAT_ID"],
        elementSetNo:
            json["ELEMENT_SET_NO"] == null ? null : json["ELEMENT_SET_NO"],
        revAtEpoch: json["REV_AT_EPOCH"] == null ? null : json["REV_AT_EPOCH"],
        bstar: json["BSTAR"] == null ? null : json["BSTAR"].toDouble(),
        meanMotionDot: json["MEAN_MOTION_DOT"] == null
            ? null
            : json["MEAN_MOTION_DOT"].toDouble(),
        meanMotionDdot: json["MEAN_MOTION_DDOT"] == null
            ? null
            : json["MEAN_MOTION_DDOT"].toDouble(),
        semimajorAxis: json["SEMIMAJOR_AXIS"] == null
            ? null
            : json["SEMIMAJOR_AXIS"].toDouble(),
        period: json["PERIOD"] == null ? null : json["PERIOD"].toDouble(),
        apoapsis: json["APOAPSIS"] == null ? null : json["APOAPSIS"].toDouble(),
        periapsis:
            json["PERIAPSIS"] == null ? null : json["PERIAPSIS"].toDouble(),
        objectType: json["OBJECT_TYPE"] == null ? null : json["OBJECT_TYPE"],
        ...
        decayed: json["DECAYED"] == null ? null : json["DECAYED"],
        file: json["FILE"] == null ? null : json["FILE"],
        gpId: json["GP_ID"] == null ? null : json["GP_ID"],
        tleLine0: json["TLE_LINE0"] == null ? null : json["TLE_LINE0"],
        tleLine1: json["TLE_LINE1"] == null ? null : json["TLE_LINE1"],
        tleLine2: json["TLE_LINE2"] == null ? null : json["TLE_LINE2"],
      );
